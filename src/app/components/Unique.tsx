    ...
    <div className="w-full bg-gray-100 py-20">
      <div className="w-full max-w-screen-xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div className="px-4 md:px-0">
          {/* Heading */}
          <h2 className="text-[#213595] text-3xl font-bold mb-6">
      ...
      {/* Add to Cart Button */}
      <Link href="/cart">
        <button className="bg-pink-600 text-white py-2 px-6 rounded-lg hover:bg-pink-600 transition-colors">
          Add To Cart
        </button>
      </Link>
            ...
            {/* Additional Text */}
            <div>
              <p className="text-[#3F509E] font-semibold text-sm">Panda Italian Sofa</p>
