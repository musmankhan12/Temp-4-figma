...
function HeroSection() {
  ...
  return (
    <section className="relative bg-gray-100 py-10 md:py-20 px-5 md:px-16 flex flex-col md:flex-row items-center justify-between overflow-hidden">
      {/* Left Column: Lamp */}
      <div className="md:w-1/4 flex justify-center items-start relative">
        <div className="absolute -top-[150px] sm:-top-[200px] left-[-20px] md:left-[-40px] z-10">
          <Image
            src="/images/bulb.png"
            alt="Lamp"
            width={300}
      ...
      <div className="md:w-1/3 max-w-lg text-center md:text-left flex flex-col justify-center">
        ...
        <h1 className="text-2xl md:text-4xl font-bold text-indigo-950 leading-tight mt-2">
          {current.title}
        </h1>
        ...
        <Link
          href="#"
          className="inline-block bg-pink-500 text-white text-sm font-medium py-3 px-6 rounded-md mt-6 hover:bg-pink-600 transition-all duration-300 w-2/3 sm:w-1/2 text-center"
        >
          {current.buttonText}
        </Link>
      </div>
      ...
      <div className="md:w-1/3 flex justify-center items-center relative">
        <div className="relative bg-gradient-to-r from-pink-100 to-purple-200 rounded-full p-8 sm:p-10 shadow-xl mt-10 mx-auto max-w-xs sm:max-w-md">
          <Image
            src='/images/sofa.png'
            alt="Furniture"
            width={600}
