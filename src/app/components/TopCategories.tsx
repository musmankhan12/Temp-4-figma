...
function TopCategories() {
  const categories = [
    { id: 1, img: "/images/chair2.png", name: "Mini Arm Chair", price: "$56.00" },
    { id: 2, img: "/images/chair.png", name: "Up Straight Chair", price: "$56.00" },
    { id: 3, img: "/images/chair5.png", name: "Mini Bar Chair", price: "$56.00" },
    { id: 4, img: "/images/chair2.png", name: "Mini Lounge Chair", price: "$56.00" },
  ];

  return (
    <div className="w-full bg-white py-20">
      {/* Heading */}
      <h2 className="text-center text-[#40a2c0] text-5xl font-bold mb-12">Top Categories</h2>
        ...
        {categories.map((category) => (
          <div key={category.id} className="relative group flex flex-col items-center">
            ...
            <div className="w-[150px] h-[150px] flex justify-center items-center bg-gray-200 rounded-full relative overflow-hidden">
              ...
              <button className="absolute bottom-2 bg-[#312ba9] text-white px-3 py-1 text-sm rounded opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                View Shop
              </button>
            </div>
