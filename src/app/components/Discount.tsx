      ...
      <div className="w-full max-w-screen-xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center md:text-left">
            ...
            <h4 className="text-pink-600 text-xl font-semibold mb-6">Panda's Sofa Compact</h4>
            <p className="text-gray-600 mb-2">
            Embrace sustainable living with our stylish, high-quality pieces,
            </p> 
            <p className="text-gray-600 mb-6"> that are as good for the planet
              as they are for your home. </p>
              <p className="text-gray-600 mb-2"> 
          ...
          <Link href="/shoplist">
            <button className="px-6 py-2 bg-[#23b0c0] text-white font-text rounded-md shadow-md hover:bg-pink-600">
              Shop Now
            </button>
          </Link>
            </div>
