...
function TrendingProducts() {
  ...
  return (
    <div className="w-full bg-white py-20">
      {/* Section Heading */}
      <h2 className="text-[#546ddd] text-5xl font-bold text-center mb-16">Trending Products</h2>
        ...
        {products.map((product) => (
          <div key={product.id} className="group relative">
            ...
            <div className="mt-4 text-center">
              ...
              <p className="text-[#3F509E] font-bold inline-block">$24.00</p>
              <span className="text-gray-500 line-through ml-2">$40.00</span>
            </div>
          </div>
        ))}
      </div>
      ...
      <div className="w-full max-w-screen-xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-pink-100 p-8 flex flex-col justify-between relative h-[200px]">
          <h3 className="text-[#584ab4] text-2xl font-bold mb-4">20% Off in all products</h3>
